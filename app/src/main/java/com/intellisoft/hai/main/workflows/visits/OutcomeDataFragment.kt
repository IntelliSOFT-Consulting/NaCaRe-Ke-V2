 ...
 * Use the [OutcomeDataFragment.newInstance] factory method to
 * create an instance of this fragment.
 */
class OutcomeDataFragment : Fragment() {
    private lateinit var binding: FragmentOutcomeDataBinding
    ...
    override fun onCreateView(
        ...
        binding = FragmentOutcomeDataBinding.inflate(layoutInflater)
